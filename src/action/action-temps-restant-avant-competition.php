<?php
    ...
    $competition = filter_var($_GET['competition'], FILTER_SANITIZE_STRING);

	$jeuDAO = new JeuDAO();
	$dateProchainTournoi = $jeuDAO->rechercherDateCompetition($competition)[0];
    // print_r($dateProchainTournoi);
